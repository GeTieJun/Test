...
<html>
<html><HEAD><TITLE>思华科技会议室管理系统</TITLE>
...
width="100%" border=0>
  ...
  <TR>
    <TD class=main_left id=frmTitle vAlign=top align=middle name="fmTitle">
      ...
      src="left/adminLeft.jsp" frameBorder=0 allowTransparency>
          </iframe>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#c4d8ed 
        ...
        <TR height=32>
          ...
          <TD background="images/bg2.gif"><SPAN 
            style="FLOAT: left;">思华科技会议室申请管理系统</SPAN><SPAN 
            id=dvbbsannounce 
            style="FONT-WEIGHT: bold; FLOAT: left; WIDTH: 300px; COLOR: #c00"></SPAN></TD>
          <TD style="COLOR: #135294; TEXT-ALIGN: right" 
          background="images/bg2.gif"><span>管理员:<span>${sessionScope.userName}</span></span>| <A 
            href="adminPage.jsp" target=_top>首页</A> 
           | <A href="javascript:AdminOut()" target=_top>退出</A> </TD>
		  ...
		  <iframe class=main_iframe id=frmright name=frmright 
      		src="roomStatisticInfo.jsp" frameBorder=0 scrolling=yes>
      	  </iframe>
